...
class MultiChannelKeypointsCompose(A.Compose):
    ...
    def __call__(self, *args, force_apply: bool = False, **data) -> typing.Dict[str, typing.Any]:
        ...
        channel_labels = self.create_channel_labels(keypoints)
        ...
        transformed_keypoints = self.order_transformed_keypoints_by_channel(keypoints,transformed_flattened_keypoints, transformed_flattened_labels)
    ...
    @staticmethod
    def order_transformed_keypoints_by_channel(original_keypoints: IMG_KEYPOINTS_TYPE, transformed_keypoints: List[KEYPOINT_TYPE], transformed_channel_labels:List[str]) -> IMG_KEYPOINTS_TYPE:
