...
- create a conda environment using `conda env create -n keypoint-detection ptyhon=3.9 && conda activate keypoint-detection && conda env update --file environment.yaml`
